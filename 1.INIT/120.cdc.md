...
###a. Environnement physique prévu
 L'application sera utilisée par tous ceux qui sont à l'intérieur de l'INSA et à lextérieur. Elle sera utilisée pendant la période de cours. Elle sera l'outil qui mettra à tous les étudiants, les enseignants, l'administration etc de l'INSA de d'être à jour dans leur travail.
###b. Environnement technologique prévu
L'application sera par un Smartphone lambda et avec le système d'exploitation Android tout en conservant le système actuel. Elle sera utilisée dans le protocole réseau quiest le HTPP(HyperText Transfer Protocol). 
###c. Applications « partenaires » (avec lesquelles le produit doit collaborer) 
L'application doit pouvoir s'interfacer avec n'importe quel navigateur HTML et elle doit accéder aux données de la version précédente.
###d. Approche « produit » prêt à être commercialisé
##14. Maintenance, support, portabilité, installation du produit
###a. Maintenance du produit 
  * L'application doit pouvoir être gérée pour les utilisateurs finaux.
  * On doit pouvoir ajouter les nouveau calendriers demandé par l'INSA.
...
###d. Exigences de portabilité
  ...
  * Elle ne sara pas vendu dans un marché.
###e. Installation du système
##15. Sécurité
###a. Accès au système
  * Seuls les administrateurs de gestion de l'application peuvent avoir accès au données.
###b. Intégrité
  * Lors de mis à jour les utilisateurs auront les notifications à l'insatant où cette mis à jour a été faite.
  * Toutes les personnes qui utilisent cette application, auront accès aux mêmes informations les permettant d'être à jours.
